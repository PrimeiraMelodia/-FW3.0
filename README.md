...
![Fundação Web3](https://images.unsplash.com/photo-1639762681485-074b7f938ba0?w=800&h=200&fit=crop)
...
```bash
git clone https://github.com/PrimeiraMelodia/Web3.git
cd Web3
```
...
[📖 Ver Guia Completo](./GUIA-DEPLOY.md)
...
Encontrou um bug? Abra uma [issue](https://github.com/PrimeiraMelodia/Web3/issues) descrevendo:
...
- 📺 [YouTube - Provoca News](https://youtube.com/@provocanews)
- 🌐 [Website](https://github.com/PrimeiraMelodia/Web3)
...
- [x] Mini-jogos educativos (6 jogos)
- [x] Sistema de autenticação
- [x] Blog integrado (WordPress)
- [x] Galeria NFT
- [x] Sistema de governança
- [x] Teste de aptidão Web3
